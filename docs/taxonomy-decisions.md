...
| Match Preview | REVIEW | Needs content audit before deciding whether it is still an active editorial format, an archive series, or better absorbed into competition/club coverage. |
| Team of the Season | REVIEW | Needs content audit. Could be an archival editorial series, active occasional feature, or material better linked to Awards/Archive depending on actual use. |
