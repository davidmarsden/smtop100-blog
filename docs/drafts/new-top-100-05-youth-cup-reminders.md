# Never miss a Youth Cup game again
...
- a **new fixture / next-round fixture** reminder when a future fixture is assigned to your club;
...
That also means the setting stays with your manager account rather than a particular browser.

## What happens if a fixture changes?

The reminder system works from the current fixture date in the Tournament Manager.

If a fixture is rescheduled, date-based reminders are tied to the updated date rather than assuming the original schedule is still correct.

Completed, forfeited, voided and cancelled matches are excluded from future reminder delivery.
...
## Why start with Youth Cup?

Because it is exactly the kind of thing a manager account should make easier.

Top 100 can publish all the fixtures it likes, but the useful question for an individual manager is much simpler:
